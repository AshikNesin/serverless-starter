...
``` bash
$ serverless install --url https://github.com/AshikNesin/serverless-starter --name my-project
```
...
## Credits
- Based on https://github.com/AnomalyInnovations/serverless-nodejs-starter
